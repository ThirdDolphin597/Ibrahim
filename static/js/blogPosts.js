const blogPosts = [
    {
        ...
        content: `
            <h2>Introduction</h2>
            <p>Creating custom printed circuit boards (PCBs) is an essential skill for any engineer. In this post, I'll walk you through my process of taking a project from breadboard prototype to PCB design and manufacturing.</p>
            
            <h2>The Lightbox Project</h2>
            <p>This PCB is part of a mandatory lightbox project for all sophomores in my robotics class. The project is an excellent way to learn PCB design, manufacturing, electronics assembly, and embedded programming all at once. The concept is simple but effective: create a standalone box with laser-engraved acrylic on top, illuminated by an LED light strip controlled by a custom PCB.</p>
            ...
            <p>Every good electronics project starts with a breadboard prototype. This allows you to test your circuit design quickly without committing to a permanent solution. For my project, I used an ATMEGA32 microcontroller to control an LED light strip. I power the circuit through USB-C and use a toggle switch to control power to the LED light strip.</p>
